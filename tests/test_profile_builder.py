...
def test_patched_release_schema_with_schema_base_url():
    ...
    # Changes `id`.
    assert (
        result["id"] == "https://standard.open-contracting.org/profiles/ppp/schema/1__0__0__beta/release-schema.json"
    )
...
def test_release_package_schema_with_schema_base_url():
    ...
    assert (
        result["id"]
        == "https://standard.open-contracting.org/profiles/ppp/schema/1__0__0__beta/release-package-schema.json"
    )
    assert (
        result["properties"]["releases"]["items"]["$ref"]
        == "https://standard.open-contracting.org/profiles/ppp/schema/1__0__0__beta/release-schema.json"
    )
...
def test_release_package_schema_with_schema_base_url_and_embed():
    ...
    assert (
        result["properties"]["releases"]["items"]["id"]
        == "https://standard.open-contracting.org/profiles/ppp/schema/1__0__0__beta/release-schema.json"
    )
...
def test_record_package_schema_with_schema_base_url():
    ...
    assert (
        result["id"]
        == "https://standard.open-contracting.org/profiles/ppp/schema/1__0__0__beta/record-package-schema.json"
    )
    assert (
        result["definitions"]["record"]["properties"]["compiledRelease"]["$ref"]
        == "https://standard.open-contracting.org/profiles/ppp/schema/1__0__0__beta/release-schema.json"
    )
    assert (
        result["definitions"]["record"]["properties"]["releases"]["oneOf"][1]["items"]["$ref"]
        == "https://standard.open-contracting.org/profiles/ppp/schema/1__0__0__beta/release-schema.json"
    )
...
def test_record_package_schema_with_schema_base_url_and_embed():
    ...
    assert (
        result["definitions"]["record"]["properties"]["compiledRelease"]["id"]
        == "https://standard.open-contracting.org/profiles/ppp/schema/1__0__0__beta/release-schema.json"
    )
    assert (
        result["definitions"]["record"]["properties"]["releases"]["oneOf"][1]["items"]["id"]
        == "https://standard.open-contracting.org/profiles/ppp/schema/1__0__0__beta/release-schema.json"
    )
...
def test_extension_codelists(caplog):
    ...
    assert max(plus_party_role)["Code"] == "socialWitness"
    ...
    assert (
        ...
        == "documentType.csv has the codes added by +documentType.csv - ignoring +documentType.csv"
    )
