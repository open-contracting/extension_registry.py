...
class Command(BaseCommand):
    ...
    def add_arguments(self):
        ...
        self.add_argument("-d", "--locale-dir", help="a directory containing MO files")
        self.add_argument("-l", "--languages", help="a comma-separated list of translations to include (default all)")
